 ...
 */
public record VotifierConfig(boolean debug, String keyPath, VoteMessageConfig voteMessage, List<RewardCommand> rewardCommands) {
    ...
    public static VotifierConfig defaults() {
        return new VotifierConfig(false, "keys", VoteMessageConfig.defaults(), List.of(
